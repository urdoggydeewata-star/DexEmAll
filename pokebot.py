...
ROUTE_MOVE_ITEMS_BY_BALL: Dict[str, List[Tuple[str, str, float]]] = {
    ...
    "tm_ball": [
        ("tm_roar", "TM Roar", 6.67),
        ("tm_bullet_seed", "TM Bullet Seed", 6.67),
        ("tm_safeguard", "TM Safeguard", 6.67),
        ("tm_double_team", "TM Double Team", 6.67),
        ("tm_shock_wave", "TM Shock Wave", 6.67),
        ("tm_rock_tomb", "TM Rock Tomb", 6.67),
        ("tm_water_pulse", "TM Water Pulse", 6.67),
        ("tm_aerial_ace", "TM Aerial Ace", 6.67),
        ("tm_secret_power", "TM Secret Power", 6.67),
        ("tm_torment", "TM Torment", 6.67),
        ("tm_rest", "TM Rest", 6.67),
        ("tm_attract", "TM Attract", 6.67),
        ("tm_thief", "TM Thief", 6.67),
        ("tm_skill_swap", "TM Skill Swap", 6.67),
        ("tm_snatch", "TM Snatch", 6.67),
    ],
    "great_tm_ball": [
        ("tm_focus_punch", "TM Focus Punch", 6.25),
        ("tm_brick_break", "TM Brick Break", 6.25),
        ("tm_calm_mind", "TM Calm Mind", 6.25),
        ("tm_hail", "TM Hail", 6.25),
        ("tm_bulk_up", "TM Bulk Up", 6.25),
        ("tm_sunny_day", "TM Sunny Day", 6.25),
        ("tm_taunt", "TM Taunt", 6.25),
        ("tm_light_screen", "TM Light Screen", 6.25),
        ("tm_protect", "TM Protect", 6.25),
        ("tm_rain_dance", "TM Rain Dance", 6.25),
        ("tm_dig", "TM Dig", 6.25),
        ("tm_sandstorm", "TM Sandstorm", 6.25),
        ("tm_facade", "TM Facade", 6.25),
        ("tm_steel_wing", "TM Steel Wing", 6.25),
        ("tm_reflect", "TM Reflect", 6.25),
        ("tm_thunder_wave", "TM Thunder Wave", 6.25),
    ],
    "ultra_tm_ball": [
        ("tm_dragon_claw", "TM Dragon Claw", 5.26),
        ("tm_toxic", "TM Toxic", 5.26),
        ("tm_hidden_power", "TM Hidden Power", 5.26),
        ("tm_ice_beam", "TM Ice Beam", 5.26),
        ("tm_blizzard", "TM Blizzard", 5.26),
        ("tm_giga_drain", "TM Giga Drain", 5.26),
        ("tm_frustration", "TM Frustration", 5.26),
        ("tm_return", "TM Return", 5.26),
        ("tm_solar_beam", "TM Solar Beam", 5.26),
        ("tm_iron_tail", "TM Iron Tail", 5.26),
        ("tm_thunderbolt", "TM Thunderbolt", 5.26),
        ("tm_thunder", "TM Thunder", 5.26),
        ("tm_earthquake", "TM Earthquake", 5.26),
        ("tm_psychic", "TM Psychic", 5.26),
        ("tm_shadow_ball", "TM Shadow Ball", 5.26),
        ("tm_flamethrower", "TM Flamethrower", 5.26),
        ("tm_sludge_bomb", "TM Sludge Bomb", 5.26),
        ("tm_fire_blast", "TM Fire Blast", 5.26),
        ("tm_overheat", "TM Overheat", 5.26),
    ],
    "level_ball": [
